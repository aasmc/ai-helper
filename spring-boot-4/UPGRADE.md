...
Зависимости, которые помечены в Maven как optional более не попадают в uber jar. https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide#optional-dependencies-in-maven
...
Удалено исключение DbActionExecutionException - потребуется переработать обработчики ошибок. https://github.com/spring-projects/spring-data-commons/wiki/Spring-Data-2025.1-Release-Notes#%EF%B8%8F-breaking-change-removal-of-dbactionexecutionexception
